        ...
        <div class="modal__content">
            ...
            <div class="modal__items">
                <ul style="list-style-type: none;">
                    <li v-for="(item, i) in listProducts" :key="item.id" style="display: gird;grid-template-columns: 30px 350px 15px; align-items:center ;padding-bottom: 5px;">
                    <p>{{ i+1 }}</p>
...
const onSave = () => {
    ...
    if (listCart.value.length>=1) {
        ...
        axios.post("/api/add_invlice", formData)
        listCart.value = []
        router.push('/');
    }
}
